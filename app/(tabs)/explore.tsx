/**
 * ===============================================
 * APLIKASI EXPO - HALAMAN ABOUT ME
 * ===============================================
 * Dibuat oleh: Dendi Pratama Riawan
      ...
      <ThemedView style={styles.content}>
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedView style={styles.infoRow}>
            ...
            <ThemedText style={styles.infoText}>Edi Suherlan</ThemedText>
          </ThemedView>
          
          {/* Baris informasi NIM */}
          <ThemedView style={styles.infoRow}>
            <ThemedText style={styles.emojiSmall}>🔢</ThemedText>
            <ThemedText style={styles.infoText}>977685667</ThemedText>
          </ThemedView>
